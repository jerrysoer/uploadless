...
import { ShieldCheck, Copy, Check, Sparkles, Loader2 } from "lucide-react";
...
export default function FullCodeReview() {
  ...
  useEffect(() => {
    trackEvent("tool_opened", { tool: "full_code_review" });
  }, []);
  ...
  const handleReview = useCallback(async () => {
    ...
    try {
      ...
      trackEvent("ai_tool_used", { tool: "full_code_review" });
    } catch {
  ...
  return (
    <div>
      <ToolPageHeader
        ...
        description="Comprehensive code review covering architecture, security, performance, and testing."
      />
